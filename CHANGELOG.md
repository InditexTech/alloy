...
## [1.13.0](https://github.com/grafana/alloy/compare/v1.12.2...v1.13.0) (2026-02-02)
...
* Add a `honor_metadata` config argument to `prometheus.operator` components ([#5321](https://github.com/grafana/alloy/issues/5321)) ([96232c8](https://github.com/grafana/alloy/commit/96232c85d781a7de90c35269d7c35dbb13a329fa))
...
* Add block_on_overflow to loki.write queue_config ([#5371](https://github.com/grafana/alloy/issues/5371)) ([810331b](https://github.com/grafana/alloy/commit/810331b005aea58ee97a898b11ef7883a3d4a01b))
* Add job level `period`, `length`, and `add_cloudwatch_timestamp` options and labels_snake_case to CW exporter ([#5015](https://github.com/grafana/alloy/issues/5015)) ([e729082](https://github.com/grafana/alloy/commit/e729082c1bb21b734ac5d284420ce3c2c4e6b60f))
...
* Database_observability.mysql: support excluding schemas in all collectors ([#5350](https://github.com/grafana/alloy/issues/5350)) ([d3542bc](https://github.com/grafana/alloy/commit/d3542bc2bc2a677a66b98478289af37bd022ff22))
* Database_observability.postgres: support excluding DBs in all collectors ([#5366](https://github.com/grafana/alloy/issues/5366)) ([1fe42db](https://github.com/grafana/alloy/commit/1fe42db8f0709757aac46d8f7e86c63802be6416))
...
* **prometheus.operator:** Add experimental support for Type and Unit labels ([#5402](https://github.com/grafana/alloy/issues/5402)) ([1834612](https://github.com/grafana/alloy/commit/1834612e59f8d5bd32d06da753bf6dd63d72d938))
* **prometheus.receive_http:** Add experimental support for AppendMetadata and TypeAndUnitLabels ([#5317](https://github.com/grafana/alloy/issues/5317)) ([fad2df2](https://github.com/grafana/alloy/commit/fad2df2fb955bd070cebe77d8790850a516dc1df))
...
* **prometheus.scrape:** Add experimental support for Type and Unit labels ([#5327](https://github.com/grafana/alloy/issues/5327)) ([a94357f](https://github.com/grafana/alloy/commit/a94357fe33a90860807445bac8d12def9b36e37d))
...
* Add support for compressed files for tail package ([#5363](https://github.com/grafana/alloy/issues/5363)) ([2347c1b](https://github.com/grafana/alloy/commit/2347c1b715330569b43c4a050fa536ac7999b2aa))
...
* Database_observability: add Azure provider relabeling rules ([#5372](https://github.com/grafana/alloy/issues/5372)) ([33683f9](https://github.com/grafana/alloy/commit/33683f9f4f3d89527fe63b2da49d982e8a4a4047))
...
* Database_observability: update BackendXID type to int64 to better map to PG xid ([#5370](https://github.com/grafana/alloy/issues/5370)) ([f5c20f5](https://github.com/grafana/alloy/commit/f5c20f5ce1b44e7e0f488cf73d1d4f783b5871b8))
...
* Guard pyroscope otel profiler code with unix go build tag ([#5357](https://github.com/grafana/alloy/issues/5357)) ([a818d6e](https://github.com/grafana/alloy/commit/a818d6e780be1fb8aa17fc9f786360c95a52c360))
...
* **loki.source.file:** Make sure position is recorded when component exit ([#5412](https://github.com/grafana/alloy/issues/5412)) ([79e138d](https://github.com/grafana/alloy/commit/79e138d24dccbea6fe87a44bf98360812eb54962))
...
* Remove 'nodes/proxy' RBAC rule and replace with 'nodes/pods'. ([#5374](https://github.com/grafana/alloy/issues/5374)) ([b5b85ae](https://github.com/grafana/alloy/commit/b5b85ae485ee06e6238c96f9295a2921a4abbf24))
* Remove Parca debug info upload from user configuration ([#5391](https://github.com/grafana/alloy/issues/5391)) ([0a749ff](https://github.com/grafana/alloy/commit/0a749ffc12de5abc0aeb78694d858072a321b39f))
